...
const menuItems: (MenuItem & { image: string })[] = [
  ...
  { 
    ...
    price: 7500, 
    category: "Golden Linking Fries",
    image: "/menu/exquisite-nibbles.png"
  },
  { 
    id: 13, 
