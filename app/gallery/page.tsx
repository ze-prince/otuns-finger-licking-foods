...
const galleryImages = [
  ...
  {
    id: 10,
    src: '/menu/gourmet.jfif',
    alt: 'The Gourmet Bites Pack',
    category: 'Golden Linking Fries',
  },
  {
    id: 11,
    src: '/menu/grazing.jfif',
    alt: 'Grazing Pack',
    category: 'Golden Linking Fries',
  },
  {
    id: 12,
    src: '/menu/exquisite.jfif',
    alt: 'Exquisite Nibbles Pack',
    category: 'Golden Linking Fries',
  },
  {
    id: 13,
    src: '/menu/petite.jfif',
  ...
  {
    id: 15,
    src: '/menu/together.jfif',
    alt: 'Togetherness Pack',
    category: 'Golden Linking Fries',
  },
  {
    id: 16,
    src: '/menu/platter.jfif',
    alt: 'The Platter Pack',
    category: 'Golden Linking Fries',
  },
  {
    id: 17,
    src: '/menu/luxury.jfif',
    alt: 'Luxury Chop Pack',
    category: 'Golden Linking Fries',
  },
  {
    id: 18,
    src: '/menu/essentials.jfif',
    alt: 'Essentials Pack',
    category: 'Golden Linking Fries',
  },
  {
    id: 19,
    src: '/menu/occassion.jfif',
    alt: "Occasion's Delight Pack",
    category: 'Golden Linking Fries',
  },
  {
    id: 20,
    src: '/menu/gather.jfif',
